...
**Locations to update:**
- The orchestrator prompt template in `convo-content-buddy-papa92` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | convo-content-buddy-papa92 | Define 4-step loop |
